...
import { casschwlanck2026LLInventory } from './ll-inventory';
import { casschwlanck2026LLDefaultPlan } from './ll-selections';
...
export const casschwlanck2026TripData: TripDataModule = {
  ...
  llInventory: casschwlanck2026LLInventory,
  llDefaultPlan: casschwlanck2026LLDefaultPlan,
};
